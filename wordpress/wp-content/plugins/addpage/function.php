	...
	if(strlen($_POST['t1'])>6)
	{
		if(strlen($_POST['t2'])>5)
		{
			if(strlen($_POST['t7'])>2)
			{
				...
				{
					$rs="-";
					$qry8="insert into book values('".$_POST['s5']."','".$_POST['s4']."','".$_POST['s6R']."','".$_POST['s7']."','".$_POST['t1']."','".$_POST['s6']."','".$_POST['t2']."','".$_POST['t3']."','".$g."','0','".$_POST['s16']."','".$_POST['t4']."','".$_POST['t5']."','".$_POST['t6']."','".$_POST['t7']."','".$_POST['t8']."','".$_POST['t9']."','".$_POST['t10']."','".$_POST['t11'].$rs.$_POST['t12']."','".$_POST['s8']."')";
...
$qry5="insert into topic value('".$_POST['s5']."','".$_POST['s6']."','".$_POST['s4']."','".$_POST['s7']."','".$_POST['t1'.$k]."','".$_POST['t2'.$k]."','".$g."','0','".$_POST['s8']."','".$_POST['t3'.$k]."')";
$res5=mysql_query($qry5);
}
}else
{
$qry5="insert into topic value('".$_POST['s5']."','".$_POST['s6']."','".$_POST['s4']."','".$_POST['s7']."','".$_POST['t10']."','".$_POST['t20']."','".$g."','0','".$_POST['s8']."','".$_POST['t30']."')";
$res5=mysql_query($qry5);
}
...
$qrt="select * from objective where fid='".$data2['id']."'";
...
<table width="80%" style="box-shadow:none">
			...
			if(strlen($_POST['t3'])>2)
			{
				if(strlen($_POST['t21'])>1 && is_numeric($_POST['t21']))
				{
					if(strlen($_POST['t22'])>1 && is_numeric($_POST['t21']))
					{
						...
						{
						$qryu="select * from syllabi where college='".$_POST['s2']."' AND level='".$_POST['s1']."' AND course='".$_POST['s4']."' AND subject='".$_POST['t2']."' AND semster='".$_POST['t1']."' AND subject_code='".$_POST['t3']." ".$_POST['tt3']."'";
						...
						$qryr="select max(id) from syllabi";
							$resr=mysql_query($qryr);
							$datas=mysql_fetch_array($resr);
						
	$qryu1="insert into objective values('0','".$datas[0]."','".$_POST['t25']."')";
	...
	$qryu1="insert into objective values('0','".$datas[0]."','".$_POST['tt'.$o]."')";
						$QRY1=mysql_query($qryu1);
		...
		if(strlen($_POST['t1'])>2)
		{
			if(strlen($_POST['t2'])>2)
			{
				if(strlen($_POST['t3'])>2)
				{
					...
					{
						$rt11="insert into publisher values('".$_POST['t2']."','".$_POST['t3']."','0')";
...
$rqyu="select * from books where id='".$_POST[$c.$i]."'";
	...
	$qrye="insert into book(college,level,branch,subject,book_name,sem,author,publication,batch,year,pp,userid) values('".$_POST['s5']."','".$_POST['s4']."','".$_POST['s6R']."','".$_POST['s7']."','".$datah['title']."','".$_POST['s6']."','".$datah['author']."','".$datah['publisher']."','".$_POST['s16']."','".$datah['year']."','".$datah['pages']."','".$g."')";
...
$qtt="select distinct(author) from books";
$qett=mysql_query($qtt);
