...
\begin{document}
\center {\color{DarkRed}\bf{\Huge{<?php echo $data['uni']; ?>}}}
\linebreak
...
\clearpage
\center{{\Huge{ \color{black}\emph{\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak <?php echo $data5['semster'];?>rd SEMESTER}}}}
\clearpage
\color{black}
...
$data=ob_get_clean();
fwrite($file,$data);
exec('pdflatex ddds.tex');
header("location:ddds.pdf");
break;
?><?php
case "yes":
	$path=$_POST['fileadd']."dddss.tex";
$file=fopen($path,"w");
ob_start();
$con=mysql_connect($_POST['dbhost'],$_POST['dbuser'],$_POST['dbpass']);
mysql_select_db($_POST['dbase'],$con);
...
?>
<?php
$qryo1="select * from syllabi where userid='".$_GET['id']."' AND branch='".$_POST['s4']."' AND batch='".$_POST['s8']."'  AND college='".$_POST['s5']."' AND semster='".$sem[$k]."'";
$resultf1=mysql_query($qryo1);
$totallect=0;
$theory=0;
$paritical=0;
...
\color{blue}\line(1,0){500}
\center{{\Large{ \color{black}\bf{<?php echo $sem[$k];?>} Semester effective for Batch <?php echo $_POST['s8']; ?>}}}
\clearpage
\center{{\Huge{ \color{black}\emph{\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak\linebreak <?php echo $sem[$k];?>   SEMESTER}}}}
\clearpage
\color{black}
\begin{tabularx}{\linewidth}{|*{15}{X|}}
\hline
...
$data=ob_get_clean();
fwrite($file,$data);
exec('pdflatex dddss.tex');
header("location:dddss.pdf");
break;
}
