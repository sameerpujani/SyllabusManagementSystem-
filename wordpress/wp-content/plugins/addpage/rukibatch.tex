...
\item {semester \bf{3}}
\item {This subject gave the knowledge about computer components.}
\end{enumerate}
...
\begin{itemize}
\item  \color{black} M. Moris Mano, \textbf{Computer System Architecture,} P. Pal Choudhri,Vol:-2,Note:-22,Year:-2011.
\end{itemize}

	
\begin{itemize}
\item  \color{black} William Stallings, \textbf{Computer Organisation and Architecture,} P. Pal Choudhri,Vol:-2,Note:-2,Year:-2011.
\end{itemize}

	
\begin{itemize}
\item  \color{black} David A Patterson, \textbf{Computer Architecture,} P. Pal Choudhri,Vol:-2,Note:-22,Year:-2013.
\end{itemize}

	
\begin{itemize}
\item  \color{black} P. Pal Choudhri, \textbf{Computer Organisation and Design,} P. Pal Choudhri,Vol:-11,Note:-22,Year:-2001.
\end{itemize}

	
\begin{itemize}
\item  \color{black} Kai Hawang, \textbf{Advanced Computer Architecture,} A \& C BLACK,Vol:-22,Note:-2,Year:-2000.
\end{itemize}
...
\item {credits: \framebox{2}}
\item {semester \bf{3}}
\item {The objective of this course is to provide the necessary back ground of discrete structures with particular
...
\begin{itemize}
\item  \color{black} Lipschutz, \textbf{Discrete Mathematics (Schaum series),} fknkfnks,Vol:-2,Note:-22,Year:-2000.
\end{itemize}
...
\item {credits: \framebox{2}}
\item {semester \bf{3}}
\item {Demonstrate the operation of simple digital gates, identify the symbols,
...
\begin{itemize}
\item  \color{black} Sartaj Sahni, \textbf{Dynamic Memory Management,} hitesh,Vol:-2,Note:-22,Year:-2001.
\end{itemize}

	
\begin{itemize}
\item  \color{black} A. A. V. I. M., \textbf{Data Structures using C and C++,} A \& C BLACK,Vol:-2,Note:-2,Year:-2011.
\end{itemize}
...
\item {credits: \framebox{2}}
\item {semester \bf{3}}
\item {mlllllllllllllllllllllllllllllll}
\end{enumerate}
...
\begin{itemize}
\item  \color{black} Lafore R, \textbf{Object Oriented Programming in C++,} William Stallings,Vol:-2,Note:-22,Year:-2013.
\end{itemize}

	
\begin{itemize}
\item  \color{black} E. Balagurusamy, \textbf{Object Oriented Programming with C++,} Bjarne Stroustrup,Vol:-1,Note:-22,Year:-2013.
\end{itemize}

	
\begin{itemize}
\item  \color{black} R. S. Salaria, \textbf{Mastering Object-Oriented Programming with C++,} Sartaj Sahni,Vol:-2,Note:-2,Year:-2000.
\end{itemize}
...
\begin{enumerate}
\item {\center {NAME OF DEPTT./CENTER: \bf{Computer Science Engineering }}}
\item {subject code: \bf{BST-307}    Course Title:   {\bf{nklllllllllll}}}
\item {Contact Hours \bf{L:3        T:2         P:1}}
\item {Examination Duration(Hrs):  \bf{Theory}\framebox{3} \bf{Practial}\framebox{1}}
\item {credits: \framebox{2}}
\item {semester \bf{4}}
\item {knnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn}
\end{enumerate}
